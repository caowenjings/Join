...
public class ForgivePassword extends AppCompatActivity {
        ...
        btn_sumbit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(musername)&&!TextUtils.isEmpty(mtel)&&!TextUtils.isEmpty(mrealname)){
                    forgivepassword(musername,mtel,mrealname);
                }else {
    ...
    private void forgivepassword(String username,String tel,String realname) {
                    ...
                    if (!"0".equals(loginresult)) {
                        ...
                        new Handler(new Handler.Callback() {
                            ...
                            public boolean handleMessage(Message arg0) {
                                //实现页面跳转
                                Intent intent=new Intent(ForgivePassword.this, Forgivepassword_one.class);
                        ...
                        Toast.makeText(ForgivePassword.this, "用户名不存在", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
...
/*
    ...
    private LinearLayout lout_password;
    ...
    private void initView() {
        ...
        lout_password = findViewById(R.id.lout_password);
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!("".equals(et_username.getText().toString()))
                        && !(et_tel.getText().toString().equals("")) && !(et_realname.getText().toString().equals(""))) {
                    Getpassword(et_username.getText().toString(), et_realname.getText().toString(), et_tel.getText().toString());
                } else {
                    Toast.makeText(ForgetPasswordActivity.this, "有选项为空！", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void Getpassword(String username, String realname, String tel) {
        String url = URL_GETPASSWORD;
        new GetpasswordAsyncTask().execute(url, username, realname, tel);
    }

    private class GetpasswordAsyncTask extends AsyncTask<String, Integer, String> {
        public GetpasswordAsyncTask() {
        }
            ...
            if (s != null) {
                try {
                    ...
                    if (!"0".equals(result)) {
                        ...
                        Intent intent = new Intent(ForgetPasswordActivity.this, UpdatePassword.class);
                        Bundle mBundle = new Bundle();
                        mBundle.putSerializable("user", user);
                        mBundle.putSerializable("method",1);
                        intent.putExtras(mBundle);
                        ...
                        lout_password.setVisibility(View.GONE);
                        Toast.makeText(ForgetPasswordActivity.this, "用户名或手机号码或真实名错误", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                ...
                System.out.println("结果为空");
                Toast.makeText(ForgetPasswordActivity.this, "网络未连接", Toast.LENGTH_LONG).show();
